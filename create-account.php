...
<div class="container">
	...
	$checkEmail = "SELECT * FROM login WHERE email = '$_POST[email]' ";

	$result = $conn-> query($checkEmail);

	$count = mysqli_num_rows($result);

	// If count == 1 significa que el correo ya esta en la DB
	if ($count == 1) {
	...
	// Query para enviar hash de nombre, correo electrónico y contraseña a la base de datos
	$query = "INSERT INTO login (name, email, password) VALUES ('$name', '$email', '$passHash')";
